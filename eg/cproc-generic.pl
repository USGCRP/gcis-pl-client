...
# Setting max_update to 35 will generate this task for all 35 references of the aforementioned reference type.
...
#  say " generic_pub :\n".Dumper($generic_pub);
 ...
 #   say " new pub :\n".Dumper($new_pub);
    ...
    $ref_form->{publication_uri} = $g->get($ref_form->{publication_uri});
